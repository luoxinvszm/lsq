...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("<script type=\"text/javascript\" src=\"");
      out.print(path );
      out.write("/js/keyWords.js\"></script>\r\n");
      ...
      out.write("    <script type=\"text/javascript\">\r\n");
      out.write("\t\t$(function(){\r\n");
      out.write("\t\t\t$(\"#messageContext\").blur(function(){\r\n");
      out.write("\t\t\t\tvar position = 0;\r\n");
      out.write("\t\t\t\tvar length = 0;\r\n");
      out.write("\t\t\t\tvar text = $(\"#messageContext\").val();\r\n");
      out.write("\t\t\t\tfor(var i = 0; i < keyWords.length ; i++){\r\n");
      out.write("\t\t\t\t\tvar next1 = next(keyWords[i]);\r\n");
      out.write("\t\t\t\t\tposition = pattern(text,keyWords[i],next1);\r\n");
      out.write("\t\t\t\t\tlength = keyWords[i].length;\r\n");
      out.write("\t\t\t\t\tif(position != undefined){\r\n");
      out.write("\t\t\t\t\t\treplaceWords(text,position,length);\r\n");
      out.write("\t\t\t\t\t\tbreak;\r\n");
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t}\t\r\n");
