...
public final class browseMessage_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t    \t$(\"#paging\").asynPage(\"qureyMessage.action\",params,\"#datas\",buildHtml,15,\"messageList\",\"totalSize\");\r\n");
      out.write("    \t\t});\r\n");
      ...
      out.write("\t\t\t\t<input type=\"text\" class=\"text\" id=\"queryExp\" value=\"信息\" />\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t\t\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\r\n");
