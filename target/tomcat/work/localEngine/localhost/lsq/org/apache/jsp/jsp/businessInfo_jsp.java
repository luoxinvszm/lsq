...
public final class businessInfo_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t$(\"#paging\").asynPage3(\"queryBusInfo\",params,\"#bus\",buildHtml,10,\"busList\",\"totalSize\");\r\n");
      out.write("});\r\n");
      out.write("function buildHtml(busList){\r\n");
      ...
      out.write("      \t\t<h1><font size=\"4px\">广告栏</font></h1>\r\n");
      out.write("            <ul class=\"btnbox\">\r\n");
      out.write("            \t<li><a href=\"");
      out.print(path);
      out.write("/jsp/welcome.jsp\">返回首页</a></li>\r\n");
      out.write("            </ul>\r\n");
      out.write("       \t\t<ul  id=\"bus\" class=\"list\">\r\n");
      out.write("            </ul>\r\n");
      out.write("          <!--分页控件 -->\r\n");
