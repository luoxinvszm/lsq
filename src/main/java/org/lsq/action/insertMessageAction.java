...
public void setInsertMessageService(IInsertMessageService insertMessageService) {
...
public String execute(){
	...
	if(insertMessageService.isInsertMessage(messageContext, publisherName, publisherPhone, msgRemark)!=0){
		return SUCCESS;
	}
	return INPUT;
