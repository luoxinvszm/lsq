...
(function($){
    ...
    $.fn.asynPage2 = function(url,params,contentContainer,buildHtml_fun,pageRowSize,callBackListName,callBackTotalSizeName){
    ...
    var fetchData = function(currPageNum){
		...
		$.ajax({
           ...
           success:function(datas,msg,xmlHttp){
				...
				settings.buildHtml_fun(data.schoolList);
